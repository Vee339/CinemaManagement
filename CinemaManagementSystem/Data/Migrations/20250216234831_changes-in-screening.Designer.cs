...
namespace CinemaManagementSystem.Data.Migrations
{
    ...
    [Migration("20250216234831_changes-in-screening")]
    partial class changesinscreening
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaManagementSystem.Models.Screening", b =>
                {
                    b.Property<int>("ScreeningId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieScreening", b =>
                {
                    ...
                    b.Property<int>("ScreeningsScreeningId")
                        .HasColumnType("int");

                    b.HasKey("MoviesMovieId", "ScreeningsScreeningId");

                    b.HasIndex("ScreeningsScreeningId");
            ...
            modelBuilder.Entity("CinemaManagementSystem.Models.Hall", b =>
                {
                    b.HasOne("CinemaManagementSystem.Models.Screening", null)
                        .WithMany("Halls")
            ...
            modelBuilder.Entity("MovieScreening", b =>
                {
                    b.HasOne("CinemaManagementSystem.Models.Movie", null)
                        .WithMany()
                    ...
                    b.HasOne("CinemaManagementSystem.Models.Screening", null)
                        .WithMany()
                        .HasForeignKey("ScreeningsScreeningId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
